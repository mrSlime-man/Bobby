...
def _sanitize_storage_state(path: str) -> dict:
    ...
    # Normalize origins.
    #
    # Playwright requires every origin object to contain:
    #
    #     "localStorage": []
    #
    # browser-use / Chromium storage exports may omit this key,
    # which otherwise crashes browser.new_context().
    ...
    if not isinstance(origins, list):
        ...
        for origin in origins:
            ...
            # An origin entry without an origin URL is unusable.
