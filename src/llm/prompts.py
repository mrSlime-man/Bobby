...
{resume}
```
##Authoritative Education Status
```
{education_status_context}
```
##Search Parameters
```
{search_parameters}
...
- A graduation/completion year alone does not establish current enrollment or student status.
- Never call the candidate a current student unless the source data explicitly states current enrollment.
